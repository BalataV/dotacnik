# Nasazení Dotačníku — krok za krokem
...
> `https://balatav.github.io/dotacnik`. Předpokládám, že tvoje GitHub uživatelské
...
3. **Repository name:** `dotacnik` (malými písmeny — bude součástí adresy).
...
git remote add origin https://github.com/balatav/dotacnik.git
git branch -M master
...
4. Počkej ~1 minutu. Nahoře se objeví adresa:
   **`https://balatav.github.io/dotacnik/`**

### 4. Ověř, že to funguje
- Úvodní stránka: <https://balatav.github.io/dotacnik/>
- Zásady ochrany údajů: <https://balatav.github.io/dotacnik/privacy.html>
- Pozvánka (test): <https://balatav.github.io/dotacnik/?g=TEST123> →
...
4. Appka „Dotačník" se objeví v telefonu jako normální aplikace.
