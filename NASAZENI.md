# Nasazení Čapího Dluhu — krok za krokem
...
> `https://balatav.github.io/capidluh`. Předpokládám, že tvoje GitHub uživatelské
...
3. **Repository name:** `capidluh` (malými písmeny — bude součástí adresy).
...
git remote add origin https://github.com/balatav/capidluh.git
git branch -M master
...
4. Počkej ~1 minutu. Nahoře se objeví adresa:
   **`https://balatav.github.io/capidluh/`**

### 4. Ověř, že to funguje
- Úvodní stránka: <https://balatav.github.io/capidluh/>
- Zásady ochrany údajů: <https://balatav.github.io/capidluh/privacy.html>
- Pozvánka (test): <https://balatav.github.io/capidluh/?g=TEST123> →
...
4. Appka „Čapí Dluh" se objeví v telefonu jako normální aplikace.
