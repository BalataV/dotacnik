# Zásady ochrany osobních údajů – Dotačníček
...
- **Technické údaje:** identifikátor účtu, čas přihlášení.

## 2. Proč to zpracováváme (účel a právní základ)
- **Poskytování služby** (vedení skupin a výpočet dluhů) – právní základ: plnění smlouvy (čl. 6 odst. 1 písm. b GDPR).
- **Přihlášení a zabezpečení** – oprávněný zájem (čl. 6 odst. 1 písm. f).
- Údaje **neprodáváme** a nepoužíváme k reklamě.

## 3. Komu se údaje předávají (zpracovatelé)
